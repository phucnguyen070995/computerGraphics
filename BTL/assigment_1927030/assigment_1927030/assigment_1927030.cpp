...
void DrawCell(float x, float y, float width, float alpha) {
	...
	glBegin(GL_POLYGON);
	glVertex3f(x, 0.0, y + width * 2 / 3.0);
	glVertex3f(x + width / 2.0, 0.0, y + width / 2.0);
	glVertex3f(x + width * 0.4, 0.0, y + width * 0.2);
	glVertex3f(x, 0.0, y + width / 3.0);
	glEnd();
	glEnable(GL_LIGHTING);
	...
	glVertex3f(x + width / 3.0, 0.0, y);
	glVertex3f(x + width * 0.4, 0.0, y + width * 0.2);
	glVertex3f(x + width * 0.7, 0.0, y + width * 0.1);
	glVertex3f(x + width * 2 / 3.0, 0.0, y);
	glEnd();
	glEnable(GL_LIGHTING);
